select ef.facilityKey, tr.requestKey, le.enumcode as equipmentEnum, tre.weeklyrequestqty, lsl.name as practicesAnyPolicies, tre.supplyremaining, tr.datecreated, ld.name as dataSource, ef.stateprovince, ef.county, lft.enumcode as facilityTypeEnum
